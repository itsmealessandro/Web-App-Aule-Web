...
public interface EventoDAO {
    ...
    List<Evento> getEventiPerResponsabile(Responsabile responsabile) throws DataException;
    ...
    List<Evento> getEventiPerSettimanaECorso(int numeroSettimana, Corso corso) throws DataException;
