...
public class ModificaEvento extends AuleWebBaseController {
  ...
  private void action_create(HttpServletRequest request, HttpServletResponse response, int e_key, String nome,
      Time oraInizio, Time oraFine, String descrizione,
      String tipologiaEvento, Date giorno, String emailR, String nAula, String nCorso)
      throws IOException, ServletException, TemplateManagerException {
    ...
    try {
      if (request.getParameter("IDMaster") != null
        ...
        if (e_key != 0) {
          ...
          // action_create(request, response, e_key, nome, oraInizio_sql, oraFine_sql,
          // descrizione, tipologiaEvento, giorno_sql, responsabile, aula, corso,
          // isRicorrente);
        }
