...
public class EventiPerSettimana extends AuleWebBaseController {
  ...
  private void action_filtro(HttpServletRequest request, HttpServletResponse response, int aula_key, int dip_key,
      LocalDate date)
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      if (request.getParameter("date") != null && request.getParameter("dip_key") != null
        ...
        // Se mancano i parametri "dip_key" o "aula_key" o "date", esegui un'azione
        // predefinita
